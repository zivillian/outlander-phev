...
.method private a(Landroid/view/ViewGroup;)V
    ...
    iput-object v5, v14, Landroidx/appcompat/app/AlertController;->o:Landroid/widget/Button;
    ...
    :cond_4
    iget-object v5, v14, Landroidx/appcompat/app/AlertController;->o:Landroid/widget/Button;

    iget-object v9, v0, Landroidx/appcompat/app/AlertController;->S:Landroid/view/View$OnClickListener;
    ...
    iget v4, v4, Landroidx/appcompat/app/AlertController;->d:I
    ...
    :cond_8
    invoke-virtual {v5, v6, v9, v4, v14}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->o:Landroid/widget/Button;

    :goto_6
    iget-object v5, v0, Landroidx/appcompat/app/AlertController;->r:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v4, v5, v15, v15, v15}, Landroid/widget/Button;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v4, v0, Landroidx/appcompat/app/AlertController;->s:Landroid/widget/Button;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->s:Landroid/widget/Button;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->t:Ljava/lang/CharSequence;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->v:Landroid/graphics/drawable/Drawable;
    ...
    :cond_f
    invoke-virtual {v4, v9, v14, v5, v8}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    iput-object v4, v0, Landroidx/appcompat/app/AlertController;->w:Landroid/widget/Button;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->w:Landroid/widget/Button;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->x:Ljava/lang/CharSequence;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->z:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, v0, Landroidx/appcompat/app/AlertController;->r:Landroid/graphics/drawable/Drawable;
    ...
    iget v5, v6, Landroidx/appcompat/app/AlertController;->d:I
    ...
    invoke-virtual {v2, v4, v15, v15, v15}, Landroid/widget/Button;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private a(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    sget v4, Lb/a/g;->scrollIndicatorDown:I
    ...
    invoke-direct {v3, p0, v2, v0}, Landroidx/appcompat/app/AlertController$b;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V

    :goto_3
    if-eqz p2, :cond_8

    invoke-virtual {p1, v3}, Landroidx/core/widget/NestedScrollView;->setOnScrollChangeListener(Landroidx/core/widget/NestedScrollView$b;)V
    ...
    invoke-direct {p2, p0, v2, v0}, Landroidx/appcompat/app/AlertController$c;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, p0, v2, v0}, Landroidx/appcompat/app/AlertController$d;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {p1, p0, v2, v0}, Landroidx/appcompat/app/AlertController$e;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method private b()I
    ...
    :cond_0
    iget v0, p0, Landroidx/appcompat/app/AlertController;->Q:I
...
.method private b(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v3, v0, p1, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method private c()V
    ...
    :cond_2
    sget v11, Lb/a/g;->contentPanel:I
    ...
    :cond_6
    invoke-direct {v4, v3}, Landroidx/appcompat/app/AlertController;->c(Landroid/view/ViewGroup;)V

    sget v4, Lb/a/g;->topPanel:I
    ...
    sget v12, Lb/a/g;->contentPanel:I
    ...
    invoke-direct {v0, v12, v8}, Landroidx/appcompat/app/AlertController;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    :cond_a
    invoke-direct {v0, v13, v11}, Landroidx/appcompat/app/AlertController;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-direct {v0, v4, v2}, Landroidx/appcompat/app/AlertController;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    :cond_c
    invoke-direct {v0, v2}, Landroidx/appcompat/app/AlertController;->b(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, v5}, Landroidx/appcompat/app/AlertController;->a(Landroid/view/ViewGroup;)V

    :cond_d
    invoke-direct {v0, v6}, Landroidx/appcompat/app/AlertController;->d(Landroid/view/ViewGroup;)V
    ...
    sget v8, Lb/a/g;->textSpacerNoButtons:I
    ...
    iget-object v8, v0, Landroidx/appcompat/app/AlertController;->A:Landroidx/core/widget/NestedScrollView;
    ...
    :cond_12
    iget-object v8, v0, Landroidx/appcompat/app/AlertController;->f:Ljava/lang/CharSequence;
    ...
    :cond_13
    sget v7, Lb/a/g;->titleDividerNoCustom:I
    ...
    sget v6, Lb/a/g;->textSpacerNoTitle:I
    ...
    :cond_16
    :goto_10
    iget-object v6, v0, Landroidx/appcompat/app/AlertController;->g:Landroid/widget/ListView;

    instance-of v6, v6, Landroidx/appcompat/app/AlertController$RecycleListView;
    ...
    invoke-virtual {v6, v4, v5}, Landroidx/appcompat/app/AlertController$RecycleListView;->a(ZZ)V

    :cond_17
    if-nez v3, :cond_1b

    iget-object v3, v0, Landroidx/appcompat/app/AlertController;->g:Landroid/widget/ListView;
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Landroidx/appcompat/app/AlertController;->a(Landroid/view/ViewGroup;Landroid/view/View;II)V
...
.method private c(Landroid/view/ViewGroup;)V
    ...
    check-cast p1, Landroidx/appcompat/widget/t1$a;

    const/4 v0, 0x0

    iput v0, p1, Landroidx/appcompat/widget/t1$a;->a:F
...
.method private d(Landroid/view/ViewGroup;)V
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/app/AlertController;->G:Landroid/view/View;
    ...
    sget v4, Lb/a/g;->title_template:I
    ...
    sget v9, Lb/a/g;->alertTitle:I

    invoke-virtual {p1, v9}, Landroid/view/Window;->findViewById(I)Landroid/view/View;
    ...
    :cond_8
    iget-object v3, p0, Landroidx/appcompat/app/AlertController;->E:Landroid/widget/TextView;
    ...
    :cond_e
    invoke-virtual {p1, v3, v0, v1, v4}, Landroid/widget/TextView;->setPadding(IIII)V
