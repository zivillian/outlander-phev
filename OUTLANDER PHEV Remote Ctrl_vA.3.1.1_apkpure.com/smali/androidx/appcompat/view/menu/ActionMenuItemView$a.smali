...
# virtual methods
.method public a()Landroidx/appcompat/view/menu/l0;
    .locals 2
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/ActionMenuItemView$b;->a()Landroidx/appcompat/view/menu/l0;
...
.method protected b()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/r$b;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    iget-object v0, v0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-interface {v1, v0}, Landroidx/appcompat/view/menu/r$b;->a(Landroidx/appcompat/view/menu/v;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/ActionMenuItemView$a;->a()Landroidx/appcompat/view/menu/l0;
