...
# interfaces
.implements Landroidx/appcompat/view/menu/g0$a;
...
# instance fields
.field e:Landroidx/appcompat/view/menu/v;

.field private f:Ljava/lang/CharSequence;

.field private g:Landroid/graphics/drawable/Drawable;

.field h:Landroidx/appcompat/view/menu/r$b;

.field private i:Landroidx/appcompat/widget/q1;
...
.method private f()V
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-virtual {v3}, Landroidx/appcompat/view/menu/v;->n()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/v;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/v;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/v;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :cond_6
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/v;->getTitle()Ljava/lang/CharSequence;
...
# virtual methods
.method public a(Landroidx/appcompat/view/menu/v;I)V
    .locals 5

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/v;->a(Landroidx/appcompat/view/menu/g0$a;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->getItemId()I
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->isVisible()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/q1;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/q1;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-virtual {v1}, Landroidx/appcompat/view/menu/v;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public d()Z
    ...
    :try_start_0
    invoke-virtual {p0}, Landroidx/appcompat/widget/b1;->getText()Ljava/lang/CharSequence;
...
.method public getItemData()Landroidx/appcompat/view/menu/v;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/r$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/r$b;->a(Landroidx/appcompat/view/menu/v;)Z
...
.method protected onMeasure(II)V
    ...
    :cond_2
    invoke-super {p0, p1, p2}, Landroidx/appcompat/widget/b1;->onMeasure(II)V
    ...
    iget v8, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:I
    ...
    invoke-super {v3, p2, v2, p1, v0}, Landroid/widget/TextView;->setPadding(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/v;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Landroidx/appcompat/widget/q1;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Landroidx/appcompat/view/menu/v;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->b()V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/r$b;)V
    .locals 0

    :try_start_0
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/view/menu/r$b;
    :try_end_0
    .catch Landroidx/appcompat/view/menu/c; {:try_start_0 .. :try_end_0} :catch_0
