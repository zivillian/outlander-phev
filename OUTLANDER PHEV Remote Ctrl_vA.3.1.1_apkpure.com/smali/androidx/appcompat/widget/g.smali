...
.method private a(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    instance-of v5, v4, Landroidx/appcompat/view/menu/g0$a;

    if-eqz v5, :cond_1

    move-object v5, v4

    check-cast v5, Landroidx/appcompat/view/menu/g0$a;

    invoke-interface {v5}, Landroidx/appcompat/view/menu/g0$a;->getItemData()Landroidx/appcompat/view/menu/v;
...
.method static synthetic a(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/r;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/view/menu/e;->d:Landroidx/appcompat/view/menu/r;

    return-object p0
.end method

.method static synthetic b(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/r;
    .locals 0
...
.method static synthetic c(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/g0;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/view/menu/e;->j:Landroidx/appcompat/view/menu/g0;

    return-object p0
.end method

.method static synthetic d(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/r;
    .locals 0
...
.method static synthetic e(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/r;
    .locals 0
...
.method static synthetic f(Landroidx/appcompat/widget/g;)Landroidx/appcompat/view/menu/g0;
    .locals 0
...
.method public a(Landroidx/appcompat/view/menu/v;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->getActionView()Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroidx/appcompat/view/menu/e;->a(Landroidx/appcompat/view/menu/v;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    :cond_1
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/v;->isActionViewExpanded()Z
...
.method public a(Landroid/content/Context;Landroidx/appcompat/view/menu/r;)V
    ...
    invoke-super {p0, p1, p2}, Landroidx/appcompat/view/menu/e;->a(Landroid/content/Context;Landroidx/appcompat/view/menu/r;)V
...
.method public a(Landroidx/appcompat/view/menu/r;Z)V
    ...
    invoke-super {p0, p1, p2}, Landroidx/appcompat/view/menu/e;->a(Landroidx/appcompat/view/menu/r;Z)V
    :try_end_0
...
.method public a(Landroidx/appcompat/view/menu/v;Landroidx/appcompat/view/menu/g0$a;)V
    .locals 2

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/g0$a;->a(Landroidx/appcompat/view/menu/v;I)V
    ...
    :goto_1
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setItemInvoker(Landroidx/appcompat/view/menu/r$b;)V
...
.method public a(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/e;->d:Landroidx/appcompat/view/menu/r;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->a(Landroidx/appcompat/view/menu/r;)V
    :try_end_0
    .catch Landroidx/appcompat/widget/h; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(Z)V
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/r;->c()Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Landroidx/appcompat/view/menu/v;->a()Lb/e/l/d;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/r;->j()Ljava/util/ArrayList;
...
.method public a(ILandroidx/appcompat/view/menu/v;)Z
    .locals 0

    invoke-virtual {p2}, Landroidx/appcompat/view/menu/v;->h()Z
...
.method public a(Landroidx/appcompat/view/menu/p0;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/p0;->t()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/e;->d:Landroidx/appcompat/view/menu/r;
    ...
    :cond_1
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/p0;->getItem()Landroid/view/MenuItem;
    ...
    :cond_2
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/p0;->getItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, v4}, Landroidx/appcompat/view/menu/r;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v2, p0, v4, p1, v0}, Landroidx/appcompat/widget/g$a;-><init>(Landroidx/appcompat/widget/g;Landroid/content/Context;Landroidx/appcompat/view/menu/p0;Landroid/view/View;)V
    ...
    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/d0;->a(Z)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/d0;->e()V

    move-object v4, p0

    :goto_6
    invoke-super {v4, p1}, Landroidx/appcompat/view/menu/e;->a(Landroidx/appcompat/view/menu/p0;)Z
...
.method public b(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/g0;
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/e;->b(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/g0;
...
.method public d()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/e;->d:Landroidx/appcompat/view/menu/r;
    ...
    iget-object v11, v13, Landroidx/appcompat/view/menu/e;->j:Landroidx/appcompat/view/menu/g0;
    ...
    check-cast v17, Landroidx/appcompat/view/menu/v;

    invoke-virtual/range {v17 .. v17}, Landroidx/appcompat/view/menu/v;->k()Z
    ...
    :cond_7
    invoke-virtual/range {v17 .. v17}, Landroidx/appcompat/view/menu/v;->j()Z
    ...
    invoke-virtual/range {v17 .. v17}, Landroidx/appcompat/view/menu/v;->isActionViewExpanded()Z
    ...
    iget-object v2, v13, Landroidx/appcompat/widget/g;->x:Landroid/util/SparseBooleanArray;
    ...
    :cond_10
    iget v13, v0, Landroidx/appcompat/widget/g;->w:I
    ...
    :goto_e
    iget v8, v8, Landroidx/appcompat/widget/g;->w:I
    ...
    check-cast v15, Landroidx/appcompat/view/menu/v;

    invoke-virtual {v15}, Landroidx/appcompat/view/menu/v;->k()Z

    move-result v16

    if-eqz v16, :cond_19

    iget-object v9, v0, Landroidx/appcompat/widget/g;->y:Landroid/view/View;

    invoke-virtual {v0, v15, v9, v12}, Landroidx/appcompat/widget/g;->a(Landroidx/appcompat/view/menu/v;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v9, v0, Landroidx/appcompat/widget/g;->y:Landroid/view/View;
    ...
    invoke-static {v9, v8, v13, v5, v3}, Landroidx/appcompat/widget/ActionMenuView;->a(Landroid/view/View;IIII)I
    ...
    :cond_15
    invoke-virtual {v9, v5, v5}, Landroid/view/View;->measure(II)V
    ...
    :cond_17
    invoke-virtual {v15}, Landroidx/appcompat/view/menu/v;->getGroupId()I
    ...
    invoke-virtual {v2, v3, v9}, Landroid/util/SparseBooleanArray;->put(IZ)V

    :cond_18
    invoke-virtual {v15, v9}, Landroidx/appcompat/view/menu/v;->d(Z)V
    ...
    :cond_19
    invoke-virtual {v15}, Landroidx/appcompat/view/menu/v;->j()Z
    ...
    invoke-virtual {v0, v15, v4, v12}, Landroidx/appcompat/widget/g;->a(Landroidx/appcompat/view/menu/v;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v4, v8, v13, v5, v7}, Landroidx/appcompat/widget/ActionMenuView;->a(Landroid/view/View;IIII)I
    ...
    check-cast v9, Landroidx/appcompat/view/menu/v;

    invoke-virtual {v9}, Landroidx/appcompat/view/menu/v;->getGroupId()I

    move-result v0

    if-ne v0, v3, :cond_29

    invoke-virtual {v9}, Landroidx/appcompat/view/menu/v;->h()Z
    ...
    invoke-virtual {v9, v0}, Landroidx/appcompat/view/menu/v;->d(Z)V
    ...
    :cond_2b
    invoke-virtual {v15, v4}, Landroidx/appcompat/view/menu/v;->d(Z)V
    ...
    invoke-virtual {v15, v0}, Landroidx/appcompat/view/menu/v;->d(Z)V
...
.method public e()Z
    ...
    :goto_1
    iput-object v3, v0, Landroidx/appcompat/widget/g;->B:Landroidx/appcompat/widget/g$c;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/d0;->a()V
...
.method public f()Z
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/d0;->a()V
    :try_end_0
    .catch Landroidx/appcompat/widget/h; {:try_start_0 .. :try_end_0} :catch_0
...
.method public h()Z
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/d0;->c()Z
...
.method public i()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/e;->j:Landroidx/appcompat/view/menu/g0;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/e;->d:Landroidx/appcompat/view/menu/r;

    iget-object v6, p0, Landroidx/appcompat/widget/g;->k:Landroidx/appcompat/widget/g$d;
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/appcompat/widget/g$e;-><init>(Landroidx/appcompat/widget/g;Landroid/content/Context;Landroidx/appcompat/view/menu/r;Landroid/view/View;Z)V
    ...
    :cond_0
    new-instance v3, Landroidx/appcompat/widget/g$c;

    invoke-direct {v3, p0, v0}, Landroidx/appcompat/widget/g$c;-><init>(Landroidx/appcompat/widget/g;Landroidx/appcompat/widget/g$e;)V
    ...
    iput-object v3, v7, Landroidx/appcompat/widget/g;->B:Landroidx/appcompat/widget/g$c;
    ...
    :goto_3
    invoke-super {v0, v5}, Landroidx/appcompat/view/menu/e;->a(Landroidx/appcompat/view/menu/p0;)Z
