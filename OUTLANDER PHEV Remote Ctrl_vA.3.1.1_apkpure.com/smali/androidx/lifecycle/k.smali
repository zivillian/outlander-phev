...
.method static b(Landroidx/lifecycle/g$a;)Landroidx/lifecycle/g$b;
    ...
    const-string v2, "Phbpyohxhj/ugw}`5`vtl\u007f;"
...
.method private c(Landroidx/lifecycle/i;)Landroidx/lifecycle/g$b;
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/lifecycle/k;->a:Lb/b/a/b/b;

    invoke-virtual {v1, p1}, Lb/b/a/b/b;->b(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    :cond_1
    iget-object v2, p0, Landroidx/lifecycle/k;->g:Ljava/util/ArrayList;
    ...
    invoke-static {v2, p1}, Landroidx/lifecycle/k;->a(Landroidx/lifecycle/g$b;Landroidx/lifecycle/g$b;)Landroidx/lifecycle/g$b;

    move-result-object p1

    invoke-static {p1, v1}, Landroidx/lifecycle/k;->a(Landroidx/lifecycle/g$b;Landroidx/lifecycle/g$b;)Landroidx/lifecycle/g$b;
...
.method private d()V
    ...
    const-string v1, "Ioamjsh`h\\jwxagfl"
    ...
    const-string v3, "Kaoohunbj_f|vf5\u007fd8~{i~|yz`\"-/( %3--fk5\";o#9=&818p,y.)%}:631#7\'-f)->j.:( ;#q4!;8v>,w"
    ...
    invoke-virtual {v6}, Lb/b/a/b/c;->b()Ljava/util/Map$Entry;
    ...
    iget-object v6, v6, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/g$b;
    ...
    :cond_6
    iget-object v5, p0, Landroidx/lifecycle/k;->a:Lb/b/a/b/b;

    invoke-virtual {v5}, Lb/b/a/b/c;->d()Ljava/util/Map$Entry;

    move-result-object v5

    iget-boolean v6, p0, Landroidx/lifecycle/k;->f:Z

    if-nez v6, :cond_3

    if-eqz v5, :cond_3

    iget-object v6, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/g$b;

    invoke-interface {v5}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroidx/lifecycle/k$b;

    iget-object v5, v5, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/g$b;
...
.method private static e(Landroidx/lifecycle/g$b;)Landroidx/lifecycle/g$a;
    ...
    const-string v2, "Fzpng}zn~x=mk!5\'c2$*2-i"
