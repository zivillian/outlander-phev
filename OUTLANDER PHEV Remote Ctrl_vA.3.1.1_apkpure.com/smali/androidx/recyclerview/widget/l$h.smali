...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/l$h;->c:Landroidx/recyclerview/widget/v$b;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/l$h;->d:Landroidx/recyclerview/widget/v$b;

    new-instance v0, Landroidx/recyclerview/widget/v;

    iget-object v1, p0, Landroidx/recyclerview/widget/l$h;->c:Landroidx/recyclerview/widget/v$b;

    invoke-direct {v0, v1}, Landroidx/recyclerview/widget/v;-><init>(Landroidx/recyclerview/widget/v$b;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/l$h;->e:Landroidx/recyclerview/widget/v;

    new-instance v0, Landroidx/recyclerview/widget/v;

    iget-object v1, p0, Landroidx/recyclerview/widget/l$h;->d:Landroidx/recyclerview/widget/v$b;

    invoke-direct {v0, v1}, Landroidx/recyclerview/widget/v;-><init>(Landroidx/recyclerview/widget/v$b;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/l$h;->f:Landroidx/recyclerview/widget/v;
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroidx/recyclerview/widget/l$h$c;
    ...
    invoke-virtual {p1, p0, p3}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    :cond_2
    sget p1, Lb/k/b;->RecyclerView_spanCount:I

    invoke-virtual {v3, p1, p3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    iput p1, v0, Landroidx/recyclerview/widget/l$h$c;->b:I
    ...
    invoke-virtual {v3, p0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
...
.method private a(Landroid/view/View;IZ)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/l$w;->i()Z
    ...
    iget-object p3, p3, Landroidx/recyclerview/widget/l;->g:Landroidx/recyclerview/widget/x;

    invoke-virtual {p3, p1}, Landroidx/recyclerview/widget/x;->c(Landroidx/recyclerview/widget/l$w;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/recyclerview/widget/x;->a(Landroidx/recyclerview/widget/l$w;)V
...
.method private a(Landroidx/recyclerview/widget/l$o;ILandroid/view/View;)V
    ...
    invoke-static {p3}, Landroidx/recyclerview/widget/l;->g(Landroid/view/View;)Landroidx/recyclerview/widget/l$w;
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/l;->g:Landroidx/recyclerview/widget/x;

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/x;->b(Landroidx/recyclerview/widget/l$w;)V
...
.method private a(Landroidx/recyclerview/widget/l;II)Z
    ...
    iget-object v9, v11, Landroidx/recyclerview/widget/l$h;->b:Landroidx/recyclerview/widget/l;
    ...
    :cond_6
    iget-object v8, v9, Landroidx/recyclerview/widget/l;->i:Landroid/graphics/Rect;
    ...
    invoke-virtual {v3, v0, v8}, Landroidx/recyclerview/widget/l$h;->b(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method a(II)V
    ...
    iput v1, p0, Landroidx/recyclerview/widget/l$h;->n:I
    ...
    iput p1, p0, Landroidx/recyclerview/widget/l$h;->l:I
    ...
    iput p1, p0, Landroidx/recyclerview/widget/l$h;->m:I
    ...
    iput v1, p0, Landroidx/recyclerview/widget/l$h;->o:I
...
.method public a(Landroid/view/View;II)V
    ...
    invoke-virtual {v3, v0}, Landroidx/recyclerview/widget/l;->e(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {v8, v11, v14, v2, v3}, Landroidx/recyclerview/widget/l$h;->a(IIIIZ)I
    ...
    invoke-virtual {v2, v0, v9, v12, v1}, Landroidx/recyclerview/widget/l$h;->a(Landroid/view/View;IILandroidx/recyclerview/widget/l$i;)Z
...
.method public a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    :cond_1
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/l;->e(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public a(Landroidx/recyclerview/widget/l$o;Landroidx/recyclerview/widget/l$t;)V
    ...
    const-string v0, "Oxm9wnoi>p6$01-!#g\'\'\u0006*5\";;\u00139;?0\'39p\u000b?8%>2:2a0&\'<%+-;fk\u001f9/;5q!\'5!3~x"
...
.method public b(I)Landroid/view/View;
    ...
    invoke-static {v3}, Landroidx/recyclerview/widget/l;->g(Landroid/view/View;)Landroidx/recyclerview/widget/l$w;
    ...
    :cond_0
    invoke-virtual {v3}, Landroidx/recyclerview/widget/l$w;->d()I

    move-result v4

    if-ne v4, p1, :cond_2

    invoke-virtual {v3}, Landroidx/recyclerview/widget/l$w;->n()Z
...
.method public b(Landroidx/recyclerview/widget/l$o;)V
    ...
    invoke-static {v1}, Landroidx/recyclerview/widget/l;->g(Landroid/view/View;)Landroidx/recyclerview/widget/l$w;
...
.method b(Landroid/view/View;IILandroidx/recyclerview/widget/l$i;)Z
    ...
    :try_start_0
    iget-boolean v1, p0, Landroidx/recyclerview/widget/l$h;->k:Z
    ...
    invoke-static {v1, p2, v2}, Landroidx/recyclerview/widget/l$h;->b(III)Z
...
.method c(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/recyclerview/widget/l;->b(II)V
    ...
    :cond_3
    invoke-virtual {p0, v8}, Landroidx/recyclerview/widget/l$h;->c(I)Landroid/view/View;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/l$h;->b:Landroidx/recyclerview/widget/l;

    iget-object v10, v9, Landroidx/recyclerview/widget/l;->i:Landroid/graphics/Rect;
    ...
    :cond_5
    invoke-virtual {p0, v12, v10}, Landroidx/recyclerview/widget/l$h;->b(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    :cond_b
    iget-object v0, v0, Landroidx/recyclerview/widget/l;->i:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v5, v3, v4, v7}, Landroid/graphics/Rect;->set(IIII)V
    ...
    :cond_d
    iget-object v10, p0, Landroidx/recyclerview/widget/l$h;->b:Landroidx/recyclerview/widget/l;

    move-object v0, p0

    :goto_7
    iget-object v1, v10, Landroidx/recyclerview/widget/l;->i:Landroid/graphics/Rect;

    invoke-virtual {v0, v1, p1, p2}, Landroidx/recyclerview/widget/l$h;->a(Landroid/graphics/Rect;II)V
...
.method public g()Landroid/view/View;
    ...
    invoke-virtual {v2, v1}, Landroidx/recyclerview/widget/b;->a(Landroid/view/View;)Z
    :try_end_0
    .catch Landroidx/recyclerview/widget/m; {:try_start_0 .. :try_end_0} :catch_0
...
.method public i()I
    ...
    iget v0, p0, Landroidx/recyclerview/widget/l$h;->m:I
...
.method public r()I
    ...
    iget v0, p0, Landroidx/recyclerview/widget/l$h;->l:I
